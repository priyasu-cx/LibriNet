    ...
    <>
      <div className="bg-white h-auto py-24 overflow-hidden flex items-center justify-center">
        <div className="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-2xl">
          ...
          <div>
            <h1 className="font-bold text-2xl md:text-4xl text-center mt-20">Admin Login</h1>
            <p className="text-sm md:text-lg text-center py-2 px-6 text-gray-500">Enter your password to access the admin dashboard.</p>
          </div>
          ...
          <form className="p-12 md:px-24 md:pb-24">
            ...
            <button className="bg-gradient-to-b from-gray-600 to-black rounded-lg font-medium p-2 md:p-4 text-white uppercase w-full">
              Login
            </button>
          </form>
        </div>
