...
const BookDetails = () => {
  ...
  console.log(book);
  return (
    <section className="text-gray-600 bg-book-cover body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-auto mx-auto flex flex-wrap">
          <img
            alt="ecommerce"
            className="lg:h-1/2 h-full lg:w-auto w-64 object-cover object-center rounded"
            src={book.book.image}
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mt-5">
              ...
              <button className="flex ml-auto text-white bg-yellow-primary border-0 py-2 px-6 focus:outline-none hover:bg-yellow-primary rounded">
                {book.book.stock > 0 ? "Add to Cart" : "Out of Stock"}
              </button>
